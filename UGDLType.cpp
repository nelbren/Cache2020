...
****************************************************/
BOOL CUGDropListType::OnDClicked(int col,int64_t row,RECT *rect,POINT *point)
{
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGDropListType::OnLClicked(int col,int64_t row,int updn,RECT *rect,POINT *point)
{	
...
Return:
	...
	FALSE - if the event was not
***************************************************/
BOOL CUGDropListType::OnMouseMove(int col,int64_t row,POINT *point,UINT flags)
{	
...
Return:
	<none>
****************************************************/
void CUGDropListType::OnKillFocus(int col,int64_t row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGDropListType::OnKeyDown(int col,int64_t row,UINT *vcKey)
{	
	// test - TD 
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGDropListType::OnCharDown(int col,int64_t row,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return
	none
****************************************************/
void CUGDropListType::OnDraw(CDC *dc,RECT *rect,int col,int64_t row,CUGCell *cell,int selected,int current)
{
	if (!m_drawThemesSet)
