...
public:
	...
	int64_t			m_keyRepeatCount; //key ballistics repeat counter
...
public:
	...
	void RedrawCell(int col,int64_t row);
	void RedrawRow(int64_t row);
	void RedrawCol(int col);
	void RedrawRange(int startCol,int64_t startRow,int endCol,int64_t endRow);
