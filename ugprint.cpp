...
Return
	...
	UG_ERROR - failure
****************************************************/
int	CUGPrint::AddPageToList(int page,int startCol,int endCol,int64_t startRow,int64_t endRow)
{
...
Return
	...
	UG_ERROR - failure
****************************************************/
int	CUGPrint::GetPageFromList(int page,int *startCol,int *endCol,int64_t *startRow,int64_t *endRow)
{
	//find the page
...
****************************************************/
int CUGPrint::PrintInit(CDC * pDC, CPrintDialog* pPD, int startCol,int64_t startRow,
						int endCol,int64_t endRow)
{
	...
	int64_t row;
	int64_t srow = startRow;		//start row for page
	int height=0,h;
	m_pagesHigh = 0;
...
****************************************************/
void CUGPrint::InternPrintCell(CDC *dc,RECT * rect,int col,int64_t row)
{
