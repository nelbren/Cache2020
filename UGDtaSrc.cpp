...
Return:
	...
	long		number of rows
****************************************************/
int64_t CUGDataSource::GetNumRows()
{
	return UG_NA;
}
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::InsertRow(int64_t row)
{
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::DeleteRow(int64_t row)
{
	UNREFERENCED_PARAMETER(row);
	return UG_NA;
}
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::DeleteCell(int col,int64_t row)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	return UG_NA;
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::GetCell(int col,int64_t row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::SetCell(int col,int64_t row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::FindFirst(CString *string,int *col,int64_t *row,long flags)
{
	UNREFERENCED_PARAMETER(*string);
	UNREFERENCED_PARAMETER(*col);
	UNREFERENCED_PARAMETER(*row);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::FindNext(CString *string,int *col,int64_t *row,int flags)
{
	UNREFERENCED_PARAMETER(*string);
	UNREFERENCED_PARAMETER(*col);
	UNREFERENCED_PARAMETER(*row);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::SortBy(int *cols,int64_t num,int flags)
{
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::SetOption(int option,int64_t param1,int64_t param2)
{
	UNREFERENCED_PARAMETER(option);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::GetOption(int option,int64_t& param1,int64_t& param2)
{
	UNREFERENCED_PARAMETER(option);
	UNREFERENCED_PARAMETER(param1);
	UNREFERENCED_PARAMETER(param2);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::GetPrevNonBlankCol(int *col,int64_t row)
{
	UNREFERENCED_PARAMETER(*col);
	UNREFERENCED_PARAMETER(row);
	return UG_NA;
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::OnHitBottom(int64_t numrows,int64_t rowspast,int64_t *rowsfound)
{
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
int CUGDataSource::OnHitTop(int64_t numrows,int64_t rowspast,int64_t *rowsfound)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
	UNREFERENCED_PARAMETER(*rowsfound);
...
Return:
	...
	1...		error codes (data source dependant)
****************************************************/
void CUGDataSource::OnRowChange(int64_t oldRow,int64_t newRow)
{
...
****************************************************/
int CUGDataSource::OnCanMove(int oldcol,int64_t oldrow,int newcol,int64_t newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
****************************************************/
int CUGDataSource::OnEditStart(int col, int64_t row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
****************************************************/
int CUGDataSource::OnEditVerify(int col,int64_t row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
****************************************************/
int CUGDataSource::OnEditFinish(int col, int64_t row,CWnd *edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
****************************************************/
int CUGDataSource::OnEditContinue(int oldcol,int64_t oldrow,int* newcol,int64_t* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
