...
****************************************************/
int CUGCellType::OnCellTypeNotify(long ID,int col,int64_t row,long msg,LONG_PTR param){
...
****************************************************/
BOOL CUGCellType::OnLClicked(int col,int64_t row,int updn,RECT *rect,POINT *point)
{
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGCellType::OnRClicked(int col,int64_t row,int updn,RECT *rect,POINT *point)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGCellType::OnDClicked(int col,int64_t row,RECT *rect,POINT *point)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGCellType::OnKeyDown(int col,int64_t row,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGCellType::OnKeyUp(int col,int64_t row,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*vcKey);
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGCellType::OnCharDown(int col,int64_t row,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*vcKey);
...
Return:
	...
	FALSE - if the event was not
****************************************************/
BOOL CUGCellType::OnMouseMove(int col,int64_t row,POINT *point,UINT flags)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
Return:
	<none>
****************************************************/
void CUGCellType::OnChangedCellWidth(int col, int64_t row, int* width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return:
	<none>
****************************************************/
void CUGCellType::OnChangingCellWidth(int col, int64_t row, int* width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*width);
...
Return:
	<none>
****************************************************/
void CUGCellType::OnChangedCellHeight(int col, int64_t row, int* height)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return
	<none>
****************************************************/
void CUGCellType::OnChangingCellHeight(int col, int64_t row, int* height) 
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
...
Return
	<none>
****************************************************/
void CUGCellType::OnSetFocus(int col,int64_t row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
Return
	<none>
****************************************************/
void CUGCellType::OnKillFocus(int col,int64_t row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
Return
	<none>
****************************************************/
void CUGCellType::OnDraw(CDC *dc,RECT *rect,int col,int64_t row,CUGCell *cell,
...
****************************************************/
#ifdef UG_ENABLE_PRINTING
void CUGCellType::OnDrawPrint(CDC *dc,RECT *rect,int col,int64_t row,CUGCell *cell,
							int selected,int current)
{
	CSize   size;
	RECT    rectOut;
...
Return:
	<none>
****************************************************/
void CUGCellType::DrawText(CDC *dc,RECT *rect,int offset,int col,int64_t row,CUGCell *cell,int selected,int current)
{
	int			left,top;
	SIZE		size;
	COLORREF	backcolor;
...
****************************************************/
#ifdef UG_ENABLE_PRINTING
void CUGCellType::OnPrint(CDC *dc,RECT *rect,int col,int64_t row,CUGCell *cell)
{
...
*****************************************************/
int CUGCellType::GetCellOverlapInfo(CDC* dc,int col,int64_t row,int *overlapCol,CUGCell *cell)
{
...
Return:
	<none>
*****************************************************/
void CUGCellType::OnScrolled(int col,int64_t row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
