...
private:
	...
	void ClearPrintList();
	int	AddPageToList(int page,int startCol,int endCol,int64_t startRow,int64_t endRow);
	int	GetPageFromList(int page,int *startCol,int *endCol,int64_t *startRow,int64_t *endRow);

	void InternPrintCell(CDC *dc,RECT * rect,int col,int64_t row);
