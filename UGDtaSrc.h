...
public:
	...
	virtual int InsertRow(int64_t row);
	virtual int AppendCol();
	virtual int InsertCol(int col);
	virtual int DeleteRow(int64_t row);
	virtual int DeleteCol(int col);
	virtual int DeleteCell(int col,int64_t row);
	virtual int Empty();

	//cell info
	virtual int	GetCell(int col,int64_t row,CUGCell *cell);
	virtual int	SetCell(int col,int64_t row,CUGCell *cell);

	//finding sorting
	virtual int FindFirst(CString *string,int *col,int64_t *row,long flags);
	virtual int FindNext(CString *string,int *col,int64_t *row,int flags);

	virtual int SortBy(int col,int flags);
	virtual int SortBy(int *cols,int64_t num,int flags);

	//options
	virtual int SetOption(int option,int64_t param1,int64_t param2);
	virtual int GetOption(int option,int64_t& param1,int64_t& param2);

	//movement 
	virtual int OnHitTop(int64_t numrows,int64_t rowspast,int64_t *rowsfound);
	virtual int OnHitBottom(int64_t numrows,int64_t rowspast,int64_t *rowsfound);
	...
	BOOL IsFunctionSupported(int64_t type);
	...
	//other functions
	virtual int GetPrevNonBlankCol(int *col,int64_t row);
};
