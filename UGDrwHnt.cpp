...
Returns:
	<none>
*****************************************************/
void CUGDrawHint::AddHint(int col,int64_t row)
{
...
Returns:
	<none>
*****************************************************/
void CUGDrawHint::AddHint(int startCol,int64_t startRow,int endCol,int64_t endRow)
{
...
Returns:
	<none>
*****************************************************/
void CUGDrawHint::AddToHint(int col,int64_t row)
{
...
Returns:
	<none>
*****************************************************/
void CUGDrawHint::AddToHint(int startCol,int64_t startRow,int endCol,int64_t endRow)
{
	if(m_List == NULL)
...
*****************************************************/
BOOL CUGDrawHint::IsInvalid(int col,int64_t row)
{
	if(m_List == NULL)
		return FALSE;
...
Returns:
	...
	FALSE		- if failed to locate the cell
*****************************************************/
BOOL CUGDrawHint::IsValid(int col,int64_t row)
{
	if(m_VList == NULL)
		return FALSE;
...
Returns:
	...
	TRUE		- on success
*****************************************************/
int CUGDrawHint::GetTotalRange(int *startCol,int64_t *startRow,int *endCol,int64_t *endRow)
{
	if(m_List == NULL)
	{
...
Returns:
	<none>
*****************************************************/
void CUGDrawHint::SetAsValid(int col,int64_t row)
{
