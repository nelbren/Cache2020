...
private:
	...
	int64_t		m_currentRow;	//current row
	...
	int64_t		m_findRow;	//current row for the findnext member

	int GotoRow(int64_t row);	//moves the internal memory pointers to the row
...
public:
	...
	int SortBy(int64_t startRow, int64_t endRow, int *cols,int numCols,int flags);
