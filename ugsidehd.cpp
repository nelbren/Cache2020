...
Returns:
	UG_SUCCESS	- success
*************************************************/
int CUGSideHdg::GetCellRect(int col,int64_t row,RECT *rect)
{
...
*************************************************/
int CUGSideHdg::GetCellFromPoint(CPoint *point,int *col,int64_t *row,RECT *rect)
{
	int ptsFound = 0;
	int xIndex;
	int64_t yIndex;
