...
Return
	UG_SUCCESS	- success
*************************************************/
int CUGTopHdg::GetCellRect(int col,int64_t row,RECT *rect)
{
...
*************************************************/
int CUGTopHdg::GetCellFromPoint(CPoint *point,int *col,int64_t *row,RECT *rect)
{
	int ptsFound = 0;
	int xIndex;
	int64_t yIndex;
...
*****************************************************/
int CUGTopHdg::GetJoinRange(int *col,int64_t *row,int *endCol,int64_t *endRow)
{
	if(m_GI->m_enableJoins == FALSE)
		return UG_ERROR;

	int startCol;
	int64_t startRow, joinRow;
	BOOL origin;
	CUGCell cell;
...
Returns:
	...
	row not found.
*****************************************************/
int CUGTopHdg::GetTHRowHeight(int64_t row)
{
