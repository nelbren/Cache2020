...
Returns:
	UG_SUCCESS, this function will never fail.
*****************************************************/
int CUGMultiSelect::StartBlock(int col,int64_t row)
{
...
*****************************************************/
int CUGMultiSelect::GetOrigCell(int *col,int64_t *row)
{
...
*****************************************************/
int CUGMultiSelect::EndBlock(int col,int64_t row)
{	
	if(m_mode&UG_MULTISELECT_OFF)
		return UG_SUCCESS;
	...
	int64_t maxLoRow  = m_currentItem->loRow;
	int64_t maxHiRow  = m_currentItem->hiRow;
	
	int oldEndCol = m_currentItem->endCol;
	int64_t oldEndRow = m_currentItem->endRow;
...
Returns:
	UG_SUCCESS, this function will never fail.
*****************************************************/
int CUGMultiSelect::ToggleCell(int col,int64_t row)
{	
	if(m_mode&UG_MULTISELECT_OFF)
		return UG_SUCCESS;
...
*****************************************************/
int CUGMultiSelect::GetCurrentBlock(int *startCol,int64_t *startRow,int *endCol,int64_t *endRow)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return UG_SUCCESS;
...
*****************************************************/
int CUGMultiSelect::IsSelected(int col,int64_t row,int *block)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return FALSE;
...
Returns:
	TRUE, FALSE indicating success (cell found) or
			failure.
*****************************************************/
int CUGMultiSelect::IsCellInRowSelected(int64_t row)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return FALSE;
...
Returns:
	...
	upon failure.
*****************************************************/
int CUGMultiSelect::EnumFirstSelected(int *col,int64_t *row)
{
	//multiselect off
	if(m_mode&UG_MULTISELECT_OFF)
	{
...
*****************************************************/
int CUGMultiSelect::EnumNextSelected(int *col,int64_t *row)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return UG_ERROR;
...
Returns:
	...
	checking.
*****************************************************/
int CUGMultiSelect::EnumFirstBlock(int *startCol,int64_t *startRow,int *endCol,int64_t *endRow)
{
	m_enumBlockNumber = 0;
	m_enumInProgress = TRUE;
...
*****************************************************/
int CUGMultiSelect::EnumNextBlock(int *startCol,int64_t *startRow,int *endCol,int64_t *endRow)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return UG_ERROR;
...
Returns:
	<none>
*****************************************************/
void CUGMultiSelect::OnLClick(int col,int64_t row, UINT nFlags)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return;
...
Returns:
	<none>
*****************************************************/
void CUGMultiSelect::OnRClick(int col,int64_t row, UINT nFlags)
{
...
Returns:
	<none>
*****************************************************/
void CUGMultiSelect::OnKeyMove(int col,int64_t row)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return;
...
Returns:
	<none>
*****************************************************/
void CUGMultiSelect::OnMouseMove(int col,int64_t row, UINT nFlags)
{
	UNREFERENCED_PARAMETER(nFlags);
...
*****************************************************/
int CUGMultiSelect::GetTotalRange(int *startCol,int64_t *startRow,int *endCol,int64_t *endRow)
{
	if(m_mode&UG_MULTISELECT_OFF)
		return UG_ERROR;
