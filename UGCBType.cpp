...
***************************************************/
BOOL CUGCheckBoxType::OnDClicked(int col,int64_t row,RECT *rect,POINT *point)
{
...
Return:
	...
	FALSE - if the event was not
***************************************************/
BOOL CUGCheckBoxType::OnLClicked(int col,int64_t row,int updn,RECT *rect,POINT *point)
{
	int top, checkSize;
...
Return:
	...
	FALSE - if the event was not
***************************************************/
BOOL CUGCheckBoxType::OnCharDown(int col,int64_t row,UINT *vcKey)
{
	m_ctrl->GetCellIndirect( col, row, &m_cell );
...
Return
	<none>
****************************************************/
void CUGCheckBoxType::OnDraw(CDC *dc,RECT *rect,int col,int64_t row,CUGCell *cell,int selected,int current)
{
	double fHScale = 1.0;
	double fVScale = 1.0;
